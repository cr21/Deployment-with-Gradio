...
python3 src/train.py experiment=food_classifier_vit_small_patch_16_224  trainer=gpu +trainer.log_every_n_steps=5 --cfg job
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
cat configs/experiment/food_classifier_vit_small_patch_16_224.yaml
